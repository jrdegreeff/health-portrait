...
- `label` _{string}_ - The label of the condition  
...
**Throws**  
- `400` if the items, label, start_date, or end_date is empty/a stream of empty spaces  
- `401` if the user is not logged in  
...
**Throws**  
- `400` If the item, label, date, or value content is empty/a stream of empty spaces  
- `400` If the label is not one of "pain," "happiness," or "cognition"  
...
- `label` _{string}_ - A new label for the point's condition  
**Returns**  
- A success message  
- An object with the updated point  
**Throws**  
- `400` if the new point value, date, or label is empty  
- `400` If the label is not one of "pain," "happiness," or "cognition"  
- `400` If the value is not one of {1, 2, 3, 4, 5}  
- `401` if the user is not logged in  
